document.addEventListener('DOMContentLoaded', function () {
    ...
    weatherButton.addEventListener('click', function () {
        ...
        if (location) {
            ...
            xhr.open('GET', `https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=d1a5e9cd313e5667a9099eaf16bd49da`, true);
            xhr.onload = function () {
                if (xhr.status === 200) {
            ...
            fetch(`https://api.openweathermap.org/data/2.5/forecast?q=${location}&appid=d1a5e9cd313e5667a9099eaf16bd49da`)
                .then(response => {
                    if (!response.ok) {
